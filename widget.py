...
"""
Credit to "jupyter-bbox-widget" I just remove the observe function in constructor
"""
...
class BBoxWidget(DOMWidget):
    ...
    def __init__(self, **kwargs):
        ...
        #self.observe(self._handle_select, names=['selected_index']) # remove this to override
